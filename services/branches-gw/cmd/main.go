...
import (
	...
	gw "github.com/eliaszs/erepro-apis/erepro/api/branches/v1"
)
...
// Run is an main function of the gateway gateway
func Run() {
	flag.Parse()
	defer glog.Flush()
	...
	err := gw.RegisterBranchesHandlerFromEndpoint(ctx, mux, apiAddr, opts)
	if err != nil {
		log.Fatal(err)
	}
