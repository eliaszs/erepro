...
func request_OrderService_GetPost_0(ctx context.Context, marshaler runtime.Marshaler, client OrderServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Order
...
func RegisterOrderServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OrderServiceClient) error {
	...
	mux.Handle("POST", pattern_OrderService_GetPost_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_OrderService_GetPost_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_OrderService_GetPost_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_OrderService_GetPost_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"order"}, ""))
)

var (
	forward_OrderService_GetPost_0 = runtime.ForwardResponseMessage
)
